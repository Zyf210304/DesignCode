...
/// 常见数据类型的`MIME Type`
public enum YFDataMimeType: String {
...
/// YFMultipartData for upload datas, eg: images/photos
public class YFMultipartData {
    ...
    convenience init(data: Data, name: String, fileName: String, type: YFDataMimeType) {
